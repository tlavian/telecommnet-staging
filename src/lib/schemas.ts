    ...
    return {
      ...
      '@graph': [
        ...
        },
        {
          ...
          priceRange: '$$$$',
          makesOffer: [
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'PSTN, VoIP & Cellular Systems Expert', url: `${BASE_URL}/communications-expert-witness/pstn-voip-cellular-expert/` } },
            ...
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Network Security Expert Witness', url: `${BASE_URL}/communications-expert-witness/network-security-expert/` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Streaming Media Expert Witness', url: `${BASE_URL}/communications-expert-witness/streaming-media-audio-and-video-conferencing-expert/` } },
            ...
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Data Communications Expert', url: `${BASE_URL}/communications-expert-witness/data-communications-expert/` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Mobile Wireless Expert', url: `${BASE_URL}/communications-expert-witness/mobile-wireless-expert/` } },
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Routing & Switching Expert', url: `${BASE_URL}/communications-expert-witness/routing-switching-expert/` } },
            ...
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Networking Expert', url: `${BASE_URL}/communications-expert-witness/networking-expert/` } },
